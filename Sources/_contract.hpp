...
#ifndef kssmath_contract_hpp
#define kssmath_contract_hpp

#include <initializer_list>
#include <string>

namespace kss { namespace math { namespace _private { namespace contract {
     ...
     */
#   define KSS_EXPR(expr) kss::math::_private::contract::_private::Expression {(expr), #expr, __PRETTY_FUNCTION__, __FILE__, __LINE__}
